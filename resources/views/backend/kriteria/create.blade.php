{{-- resources/views/backend/kriteria/create.blade.php --}}
@extends('backend.layouts.main')

@section('content')

<div class="d-sm-flex justify-content-between align-items-center mb-4">
    <h3 class="fs-18">Tambah Data Kriteria</h3>
            ...
            <div class="row">
                ...
                <div class="col-lg-12 mb-3">
                    <div class="alert alert-info">
                        ...
                        <ul class="mb-0 mt-1">
                            ...
                            <li>Nama kriteria akan digunakan sebagai field di tabel hasil survei</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-lg-12 mt-3">
                    <button type="submit" class="btn btn-primary">
                        <i data-feather="save"></i> Simpan Kriteria
                    </button>
