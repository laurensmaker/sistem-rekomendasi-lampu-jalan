{{-- resources/views/backend/hasil-survei/edit.blade.php --}}
@extends('backend.layouts.main')

@section('content')

<div class="d-sm-flex justify-content-between align-items-center mb-4">
    <h3 class="fs-18">Edit Data Hasil Survei</h3>
    <div>
...
<div class="card bg-white border-0 rounded-10 mb-4">
    <div class="card-body p-4">
        <form action="{{ route('hasil-survei.update', $hasilSurvei->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="row">
                ...
                <div class="col-lg-6 mb-3">
                    ...
                    <select name="lokasi_id" 
                        ...
                        @foreach($lokasi as $item)
                            <option value="{{ $item->id }}" {{ old('lokasi_id', $hasilSurvei->lokasi_id) == $item->id ? 'selected' : '' }}>
                ...
                <div class="col-lg-6 mb-3">
                    ...
                    <select name="dokumentasi_id" 
                        ...
                        @foreach($dokumentasi as $item)
                            <option value="{{ $item->id }}" {{ old('dokumentasi_id', $hasilSurvei->dokumentasi_id) == $item->id ? 'selected' : '' }}>
                ...
                <div class="col-lg-6 mb-3">
                    ...
                    <input type="date" 
                           ...
                           value="{{ old('tanggal_survei', $hasilSurvei->tanggal_survei->format('Y-m-d')) }}"
                           required>
                ...
                <div class="col-lg-6 mb-3">
                    <div class="form-control bg-light">
                        ...
                        <p class="mb-0">
                            <span class="badge bg-info">ID: #{{ $hasilSurvei->id }}</span>
                            <span class="badge bg-{{ $hasilSurvei->nilai_preferensi !== null ? 'success' : 'warning' }}">
                                {{ $hasilSurvei->nilai_preferensi !== null ? 'Sudah Dihitung SAW' : 'Belum Dihitung SAW' }}
                            </span>
                        </p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 mb-3">
                    ...
                    <input type="number" 
                           ...
                           value="{{ old('panjang_jalan', $hasilSurvei->panjang_jalan) }}"
                ...
                <div class="col-lg-4 mb-3">
                    ...
                    <input type="number" 
                           ...
                           value="{{ old('lebar_jalan', $hasilSurvei->lebar_jalan) }}"
                ...
                <div class="col-lg-4 mb-3">
                    ...
                    <input type="number" 
                           ...
                           value="{{ old('tinggi_tiang', $hasilSurvei->tinggi_tiang) }}"
                ...
                <div class="col-lg-6 mb-3">
                    ...
                    <input type="number" 
                           ...
                           value="{{ old('kepadatan_penduduk', $hasilSurvei->kepadatan_penduduk) }}"
                ...
                <div class="col-lg-6 mb-3">
                    ...
                    <input type="number" 
                           ...
                           value="{{ old('volume_lalu_lintas', $hasilSurvei->volume_lalu_lintas) }}"
                           placeholder="Masukkan nilai 1-5" 
                           min="1" 
                           max="5"
                           step="1"
                ...
                <div class="col-lg-6 mb-3">
                    ...
                    <input type="number" 
                           ...
                           value="{{ old('aktivitas_malam', $hasilSurvei->aktivitas_malam) }}"
                           placeholder="Masukkan nilai 1-5" 
                           min="1" 
                           max="5"
                           step="1"
                ...
                <div class="col-lg-6 mb-3">
                    ...
                    <input type="number" 
                           ...
                           value="{{ old('penerangan_saat_ini', $hasilSurvei->penerangan_saat_ini) }}"
                           placeholder="Masukkan nilai 1-5" 
                           min="1" 
                           max="5"
                           step="1"
                ...
                <div class="col-lg-6 mb-3">
                    ...
                    <input type="number" 
                           ...
                           value="{{ old('kerawanan_kecelakaan', $hasilSurvei->kerawanan_kecelakaan) }}"
                           placeholder="Masukkan nilai 1-5" 
                           min="1" 
                           max="5"
                           step="1"
                ...
                <div class="col-lg-12 mb-3 mt-3">
                    <div class="alert alert-warning">
                        ...
                        <ul class="mb-0 mt-1">
                            <li>Jika Anda mengubah nilai kriteria atau data fisik, <strong>nilai preferensi SAW akan direset</strong> dan perlu dihitung ulang</li>
                ...
                <div class="col-lg-12 mt-3">
                    <button type="submit" class="btn btn-primary">
                        <i data-feather="save"></i> Update Survei
                    </button>
